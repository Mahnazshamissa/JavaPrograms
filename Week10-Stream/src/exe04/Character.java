...
public class Character {
    ...
    private Integer bookIntroChapter;
    ...
    public Character(String name, String allegiances, String deathYear, String bookOfDeath, String deathChapter, Integer bookIntroChapter, Integer gender, Integer nobility, Integer goT, Integer coK, Integer soS, Integer ffC, Integer dwD) {
        this.name = name;
    ...
    public Integer getBookIntroChapter() {
